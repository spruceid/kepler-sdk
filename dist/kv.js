...
var KV = /** @class */ (function () {
    function KV(url, auth) {
        ...
        this.invoke = function (params) {
            return kepler_1.invoke(_this.url, params);
        };
    }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.invoke;
                        _b = {};
                        return [4 /*yield*/, this.auth.invocationHeaders("get", key)];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.invoke;
                        _b = {};
                        return [4 /*yield*/, this.auth.invocationHeaders("metadata", key)];
                    case 1: return [4 /*yield*/, _a.apply(this, [(_b.headers = _c.sent(),
                                _b)])];
                    case 2: return [2 /*return*/, _c.sent()];
                }
            ...
            return __generator(this, function (_d) {
                switch (_d.label) {
                    case 0:
                        ...
                        return [4 /*yield*/, this.auth.invocationHeaders("put", key)];
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.invoke;
                        _b = {};
                        return [4 /*yield*/, this.auth.invocationHeaders("del", key)];
                    case 1: return [4 /*yield*/, _a.apply(this, [(_b.headers = _c.sent(),
                                _b)])];
                    case 2: return [2 /*return*/, _c.sent()];
                }
            ...
            return __generator(this, function (_c) {
                switch (_c.label) {
                    case 0:
                        _a = this.invoke;
                        _b = {};
                        return [4 /*yield*/, this.auth.invocationHeaders("list", prefix)];
                    case 1: return [4 /*yield*/, _a.apply(this, [(_b.headers = _c.sent(),
                                _b)])];
                    case 2: return [2 /*return*/, _c.sent()];
                }
